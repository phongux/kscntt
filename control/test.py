        ...
        <script>
            ...
            hot = new Handsontable($container[0], {{
                ...
                afterChange: function (change, source) {{
                    var data;
                    if (source === 'loadData' || source === 'UndoRedo.undo'){{
                        return;
                    }}
            ...
            $parent.find('button[name=load]').click(function () {{
                ...
                $(".page2").html("<strong>Page <span id='page_number'>"+page_number+"</span> / <span id='total_page'>" + Math.round(res.sum_page)+"</span></strong>");
                $('.demo2').bootpag({{
                    total: res.sum_page,
                    page: page_number,
                    maxVisible: 10,
