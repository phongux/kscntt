...
def application(environment, start_response):
    ...
    if 'username' not in session:
        ...
        <script>
        var display = {display};
        var colu = ["id", "ngay","so_phieu","ma_hang","ten_hang","don_vi_tinh", "so_luong","don_gia","thanh_tien","ghi_chu","update_time"];
    var $$ = function(id) {{
    ...
    hot = new Handsontable($container[0], {{
        ...
        autoWrapRow: true,
        rowHeaders: true,
             colHeaders: ['Id', 'Ngay', 'So Phieu', 'Ma Hang', 'Ten Hang', 'Don Vi Tinh', 'So Luong', 'Don Gia', 'Thanh Tien', 'Ghi Chu', 'Update Time'],
            columns: [{{'readOnly': 'true'}}, {{}}, {{}}, {{}}, {{}}, {{}}, {{}}, {{}}, {{}}, {{}}, {{'readOnly': 'true'}}],
            colWidths: [0.1,50,50,50,50,50,50,50,50,50,50],        
